...
echo 'deb [signed-by=/usr/share/keyrings/openziti.gpg] https://packages.openziti.org/zitipax-openziti-deb-stable jammy main' | sudo tee --append /etc/apt/sources.list.d/openziti.list >/dev/null
sudo apt update

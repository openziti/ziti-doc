...
Above you'll see my controller is running in a container named "xenodochial_cori". I can tell because it's using port
1280. Now I can `exec` into this container: `docker exec -it xenodochial_cori /bin/bash`

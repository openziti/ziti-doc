...
* ![](/blogs/openziti/v1712854086884/8b08379c-00c2-4e12-a2fb-cb9f0a3bc975.png)
    ...
    You have an OpenZiti overlay network available. If not, for this scenario you will want to use a [deployment guide](@openzitidocs/category/deployments). You'll also want to have the ziti cli tool on your path

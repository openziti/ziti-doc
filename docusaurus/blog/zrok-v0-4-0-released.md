...
image: /blog/v1687898203990/c35b6581-ab18-4f3d-80b7-8b2bfb7035cc.avif
tags: 
  - network
  - security
  - networking
...
![`zrok share` command for creating a TCP tunnel.](/blog/v1687806922797/0e19e031-b673-4ec3-b416-9703af9c7713.png)

We'll use the `tcpTunnel` backend mode with our `private` share. The target is the `<host>:<port>` destination for the tunnel.

![](/blog/v1687886605811/9280f0cf-496d-45b3-b454-eb44fd53fff4.png)
...
![](/blog/v1687886726762/268bc129-df9c-4d55-a635-69d43536396e.png)
...
![Using netcat locally to access the tunneled SSH server endpoint.](/blog/v1687807081992/cdf0073e-e1c0-4caf-82ce-a6acb19002c4.png)
...
![The `zrok` `v0.4.0` web console, showing the new access endpoints and the private links between share and access.](/blog/v1687802216025/c81239e3-d488-4caf-882d-af88c523dea5.png)

In the screenshot above, a dashed green line shows a connection between a `zrok share private` and a `zrok access`.

![](/blog/v1687886867051/c6b3dc7d-efff-467f-a127-59d45ed007ae.png)

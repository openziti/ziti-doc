...
1. Ensure you have a OpenZiti router in the cluster with a tunnel binding. You can use this command to find eligible routers.
    ...
    If none of the routers shown are in your cluster, then refer to [the router deployment guide](/how-to-guides/deployments/30-kubernetes/kubernetes-router.mdx) for more information on how to deploy a router.

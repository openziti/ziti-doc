...
Login to your VMs created earlier, follow [Install Linux Package](../../reference/tunnelers/60-linux/index.mdx) **Ubuntu Jammy 22.04** section to install and register your ziti-edge-tunnel.

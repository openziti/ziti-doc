...
- Local edge router (**local-er**). Please follow the [Router guide](../deployments/40-cloud/20-router.mdx) to setup a [Router with edge listener and tunneler](../deployments/40-cloud/20-router.mdx#2343-create-the-router-with-edge-listener-and-tunneler). For this router, you will need to setup [Resolver](/how-to-guides/deployments/40-cloud/20-router.mdx#26-fix-the-resolver), [Route Table](/how-to-guides/deployments/40-cloud/20-router.mdx#27-route-table), [Source and Destination Check](/how-to-guides/deployments/40-cloud/20-router.mdx#28-source-and-destination-check) and [Firewall](/how-to-guides/deployments/40-cloud/20-router.mdx#29-firewall).
...
Login to your VMs created earlier, follow [Install Linux Package](../../how-to-guides/tunnelers/60-linux/index.mdx) **Ubuntu Jammy 22.04** section to install and register your ziti-edge-tunnel.

---
title: Tunnel to NGINX upstreams
...
- [Local quickstart](@openzitidocs/get-started/network)
- [Linux](@openzitiactive/category/linux)
- [Docker](@openzitiactive/category/docker)
...
- Windows ZDE Identity can be enrolled by following this [enrolling process](/how-to-guides/tunnelers/02-windows/index.md)

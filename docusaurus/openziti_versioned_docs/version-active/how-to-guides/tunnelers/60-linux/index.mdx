...
1. Upgrade the tunneler when a new package is available.
...
Reference [the article about running the Linux tunneler in a container](/how-to-guides/tunnelers/70-docker/readme.mdx) for guidance and
examples.

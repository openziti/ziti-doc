---
sidebar_position: 60
sidebar_label: "Local: Kubernetes"
---
...
:::info
Quickstarts are short-lived networks that are great for learning how to use OpenZiti. For long-lived production deployments, see [the deployment guides](@openzitiactive/category/kubernetes).
:::
...
1. Deploy a non-Ziti demo application to Kubernetes and securely [share it with a Ziti proxy pod](../../how-to-guides/tunnelers/80-kubernetes/kubernetes-service.md)

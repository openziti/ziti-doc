---
sidebar_position: 40
sidebar_label: "Local: With Docker"
---
...
:::info
Quickstarts are short-lived networks that are great for learning how to use OpenZiti. For long-lived production deployments, see [the deployment guides](@openzitiactive/category/docker).
:::

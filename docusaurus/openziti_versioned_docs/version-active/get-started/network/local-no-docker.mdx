...
This page will show you how to get your [network](../../intro.md) up and running 
...
At this point you should have a functioning [network](../../intro.md). The script 

...
export const openZitiFooter = {
    description: 'OpenZiti is an open source project that enables developers to embed zero-trust networking directly into applications.',
    socialProps: {
    ...
    documentationLinks: [
        { href: '/docs/openziti/intro', label: 'Getting Started' },

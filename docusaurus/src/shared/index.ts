...
export const DOCUSAURUS_BASE_PATH = process.env.DOCUSAURUS_BASE_PATH || '/DOCUSAURUS_BASE_PATH-unset';
export const DOCUSAURUS_DOCS_PATH = process.env.DOCUSAURUS_DOCS_PATH || '/DOCUSAURUS_DOCS_PATH-unset';

...
import styles from "./index-variant1.module.css"
    ...
    return (
        <OpenZitiLayout>
            <OpenZitiHorizontalSection style={{fontSize:"large", padding: "50px"}}>
                <div style={{display: "flex", flexDirection: "row", flexWrap: "wrap", minWidth: "300px"}}>

                    <div className={styles.titleSection} style={{maxWidth: "350px", flexWrap:"nowrap"}}>
            ...
            {/*    <div className={styles.textSection} style={{backgroundColor: "var(--callout-color)"}}>*/}

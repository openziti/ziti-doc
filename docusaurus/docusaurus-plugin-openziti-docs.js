...
export function openzitiRedirects(routeBasePath = 'docs/openziti') {
...
export function openzitiDocsPluginConfig(rootDir, linkMappings, routeBasePath = 'docs/openziti') {
                ...
                function forbidSite() {
                    return (tree, file) => {
                        ...
                        if (src.includes('@site')) {
                            throw new Error(`[FORBIDDEN] @site is not allowed in docs - use @openziti.\nFile: ${file.path}`);
                        }
                    };
                },

    ...
    [
      'redocusaurus',
      {
        ...
        specs: [
          {
            id: 'edge-client',
            spec: 'https://get.openziti.io/specs/edge/client.yml',
          },
          {
            id: 'edge-management',
            spec: 'https://get.openziti.io/specs/edge/management.yml',
          },
          {
            id: 'fabric',
            spec: 'https://get.openziti.io/specs/fabric/swagger.yml'
          }
        ],

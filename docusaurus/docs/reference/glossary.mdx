...
## [Edge Router Policy](@openzitidocs/learn/core-concepts/security/authorization/policies/overview#edge-router-policies)
...
## [Service Edge Router Policy](@openzitidocs/learn/core-concepts/security/authorization/policies/overview#service-edge-router-policies)

<SERPBrief />

## [Session](@openzitidocs/learn/core-concepts/security/sessions#session)
...
## [Path](@openzitidocs/learn/core-concepts/data-flow-explainer)
...
The Ziti Edge implements the zero trust connectivity framework as an overlay application on top of the Ziti Fabric. The Ziti Edge provides connectivity for endpoints through two primary mechanisms: tunnelers that add zero trust to existing applications with no code changes, and the Ziti Edge SDK for embedding zero trust directly into applications. Both approaches provide authentication, authorization, and end-to-end encryption.
...
## [Ziti Endpoint SDK, Endpoint SDK, SDK](@openzitidocs/reference/developer/sdk/index)
...
## [Ziti Fabric, Fabric](@openzitidocs/intro/what-is-openziti/30-openziti-is-software#fabric)
...
Ziti is a modern, programmable zero trust network overlay. It provides authenticated, authorized, and encrypted connectivity for any application - whether integrated via tunnelers, SDKs, or edge routers.
...
## [Ziti Service, Service](@openzitidocs/learn/core-concepts/services/overview)
...
## [Ziti Tunneler, Tunneler](@openzitidocs/how-to-guides/tunnelers/index)

A tunneler adds zero trust connectivity to existing applications with no code changes. Tunnelers provide an underlay connectivity component (TUN, tproxy, etc.) and use the Ziti Endpoint SDK to bridge application traffic onto the Ziti network.

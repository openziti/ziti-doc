...
![ext-jwt-signer-basic](/img/ext-jwt-signer/ext-jwt-signer-basic.png)
...
## Adding the Identity
 ...
 the user to click on the "ADD IDENTITY" button in the top right of the screen. After the context menu pops up,
select the JWT file and the identity will be added to the system.

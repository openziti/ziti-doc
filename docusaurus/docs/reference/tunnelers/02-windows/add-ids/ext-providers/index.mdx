...
[Zitadel](../../../../../guides/external-auth/identity-providers/zitadel.mdx) and others. 
The OpenZiti Controller has an authentication system utilizing JWTs as authentication tokens.
The [External JWT Signers](../../../../../learn/core-concepts/security/authentication/50-external-jwt-signers.mdx)

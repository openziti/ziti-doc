...
For more information about configuring the underlying Ziti C SDK with environment variables, see [the Ziti C SDK documentation](/docs/reference/developer/sdk/clang/ziti__log_8h.html).

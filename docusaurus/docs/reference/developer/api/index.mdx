...
[Explore the latest edge management API Reference](@openzitidocs/reference/developer/api/edge-management-api-reference)

## Edge Client API

The edge client API is used by clients that wish to dial (connect) or bind (host) services. The services that the
clients are allowed to interact with is defined by [policies](../../../learn/core-concepts/security/authorization/policies/overview.mdx). In order
for clients to use the client API they must first [authenticate](../../../learn/core-concepts/security/authentication/00-auth.md) and
obtain either a [partial or fully authenticated](../../../learn/core-concepts/security/sessions.md#full-vs-partial-authentication)
[API Session](../../../learn/core-concepts/security/sessions.md).

[Explore the latest edge client API Reference](@openzitidocs/reference/developer/api/edge-client-api-reference)

## Edge Client and Management shared capabilities

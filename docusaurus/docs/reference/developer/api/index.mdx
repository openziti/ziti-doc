...
[Explore the latest edge management API Reference](/docs/openziti/reference/developer/api/edge-management-api-reference)
...
[Explore the latest edge client API Reference](/docs/openziti/reference/developer/api/edge-client-api-reference)

...
* **Configuration** - Ziti allows application specific configuration to be stored for services. See [Configuration Store](/docs/core-concepts/config-store/overview)
* **Authorization** - For a details on controlling access to services, see [Policies](/docs/core-concepts/security/authorization/policies/overview).

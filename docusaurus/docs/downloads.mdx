...
This package depends on the `openziti` package that provides the `ziti` CLI. Follow [the deployment reference](/reference/deployments/01-controller.md) to configure the controller before starting the service.
...
This package depends on the `openziti` package that provides the `ziti` CLI. Follow [the deployment reference](/reference/deployments/02-router/01-deployment.md) to configure the router before starting the service.

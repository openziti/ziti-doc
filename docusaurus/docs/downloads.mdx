...
This package depends on the `openziti` package that provides the `ziti` CLI. Follow [the deployment reference](/guides/deployments/10-controller/10-deploy.mdx) to configure the controller before starting the service.
...
This package depends on the `openziti` package that provides the `ziti` CLI. Follow [the deployment reference](/guides/deployments/20-router/10-deploy.mdx) to configure the router before starting the service.
...
[Learn about self-hosting Ziti in Kubernetes](/docs/category/self-hosting)

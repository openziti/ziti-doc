...
This package depends on the `openziti` package that provides the `ziti` CLI. Follow [the deployment reference](/guides/deployments/10-controller/index.mdx) to configure the controller before starting the service.
...
This package depends on the `openziti` package that provides the `ziti` CLI. Follow [the deployment reference](/guides/deployments/20-router/10-deployment.md) to configure the router before starting the service.

...
Follow the Debian instructions [to install the `ziti-edge-tunnel` DEB](/reference/tunnelers/linux/index.mdx#installing-the-deb)
...
Follow the Red Hat instructions to [install the `ziti-edge-tunnel` RPM](/reference/tunnelers/linux/index.mdx#installing-the-rpm)
...
Download [the latest binary from GitHub](https://github.com/openziti/ziti-tunnel-sdk-c/releases/latest/) and follow the [manual binary install instructions](/reference/tunnelers/linux/index.mdx#manual-installation)
...
[Run a tunneler with Docker](/reference/tunnelers/docker/readme.mdx)
...
[Learn about tunneling workloads in Kubernetes](/guides/tunneling/30-kubernetes/index.mdx)

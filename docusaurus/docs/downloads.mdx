...
### Install the Ziti Command

Configure the OpenZiti package repository and installs the `ziti` CLI.
...
Download [the latest binary from GitHub](https://github.com/openziti/ziti-tunnel-sdk-c/releases/latest/) and follow the [manual install instructions for `ziti-edge-tunnel`](/reference/tunnelers/linux/index.md#manual-installation)

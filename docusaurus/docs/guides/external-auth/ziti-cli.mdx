...
INFO    using supplied redirect url: http://localhost:20314/auth/callback
INFO    found external JWT signer
INFO      - issuer: https://keycloak.zrok.clint.demo.openziti.org:8446/realms/zitirealm/
INFO      - clientId: browzer-keycloak-ext-jwt-signer
...
```text
FATAL   error authenticating with token: unable to authenticate to https://ec2-3-142-245-63.us-east-2.compute.amazonaws.com:8441/edge/management/v1. Status code: 401 Unauthorized, Server returned: {
    "error": {
        "code": "INVALID_AUTH",

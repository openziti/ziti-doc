...
<img src="/icons/logo-authentik.svg" alt="How to configure Authentik for OpenZiti" height="100px"/>
...
| Field                 | Where to Find the Value in the Authentik Configuration                                       | Example                                                      |
|-----------------------|----------------------------------------------------------------------------------------------|--------------------------------------------------------------|
| **Issuer**            | Shown on the right as the "OpenID Configuration Issuer"                                      | https://my.authentik.server:9243/application/o/openziti-api/ |
...
| **External Auth URL** | The same value as the Issuer                                                                 | https://my.authentik.server:9243/application/o/openziti-api/ |
| **JWKS Endpoint**     | Shown on the right as the "JWKS URL"                                                         | https://Authentik.example.com/jwks.json                      |

...
| **JWKS Endpoint**     | A url the OpenZiti Controller can use to retrieve a [JSON Web Key Set](https://en.wikipedia.org/wiki/JSON_Web_Token), used to verify JWTs   | https://Cognito.example.com/jwks.json |

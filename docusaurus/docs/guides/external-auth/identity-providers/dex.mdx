...
|-----------------------|----------------------------------------------------------------------------------------------|---------------------------------------------------------|
| **Issuer**            | In the dex config.yaml file, key "issuer"                                                    | https://dex.zrok.clint.demo.openziti.org                |
...
| **External Auth URL** | The same value as the Issuer                                                                 | https://dex.zrok.clint.demo.openziti.org                |
| **JWKS Endpoint**     | Use the `jwks_uri` field from the './well-known/openid-configuration' endpoint               | https://dex.zrok.clint.demo.openziti.org/keys           |
...
issuer: https://dex.zrok.clint.demo.openziti.org:5556

web:
  http: ""  # Disable HTTP
  https: 0.0.0.0:5556
  tlsCert: /certs/live/zrok.clint.demo.openziti.org/fullchain.pem
  tlsKey: /certs/live/zrok.clint.demo.openziti.org/privkey.pem
storage:
  type: sqlite3
  config:
    file: /var/dex/dex.db
...
- type: github
  ...
  config:
    ...
    redirectURI: https://dex.zrok.clint.demo.openziti.org:5556/callback

...
Login to your VMs created earlier, follow [Install Linux Package](@openzitidocs/reference/tunnelers/linux/) **Ubuntu Jammy 22.04** section to install and register your ziti-edge-tunnel.

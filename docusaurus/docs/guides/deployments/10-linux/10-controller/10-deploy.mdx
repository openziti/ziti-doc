...
This article is about deploying a Ziti Controller as a Linux system service. [The controller introduction](/learn/introduction/03-components.md#openziti-controller) may be helpful to read first.
...
If you install interactively then you'll have an opportunity to answer questions about generating a configuration.
...
You can generate a configuration by opting-in to bootstrapping during an interactive install which prompts for the most relevant answers, or by setting these values in the answer file.

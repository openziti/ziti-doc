...
This article is about deploying a controller as a Linux system service. [The controller introduction](/learn/introduction/03-components.md#openziti-controller) may be helpful to read first.

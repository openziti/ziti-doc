...
This article is about deploying a router as a Linux system service. [The router introduction](/learn/introduction/components#router) may be helpful to read first.
...
You must create the router in the controller first with [the web console](/guides/deployments/10-linux/30-console.mdx) or [the CLI](/guides/deployments/10-linux/20-router/cli-mgmt).

After [creating the router](/guides/deployments/10-linux/20-router/cli-mgmt#create-a-router), save the enrollment token (JWT) and provide the file path to the router during the configuration step below.
...
Learn more about [managing routers with the CLI](/guides/deployments/10-linux/20-router/cli-mgmt).

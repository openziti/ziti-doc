...
[Link to API reference for the re-enroll operation](../../../../reference/developer/api/02-edge-management-reference.mdx#tag/Edge-Router/operation/reEnrollEdgeRouter)<!--DocusaurusIgnoreBrokenLinks-->.

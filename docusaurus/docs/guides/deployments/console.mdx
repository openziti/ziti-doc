...
As mentioned in the [identity](/docs/reference/30-configuration/conventions.md#identity) section of the Conventions reference document, you can
...
This may take a few minutes to a few hours, but you can use tools like [whatsmydns](https://www.whatsmydns.net/)

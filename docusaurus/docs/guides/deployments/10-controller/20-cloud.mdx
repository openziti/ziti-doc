...
Use the DNS name to setup the controller with [Host OpenZiti Anywhere](/learn/quickstarts/network/hosted.md). 
...
```
Then follow the [Host OpenZiti Anywhere](/learn/quickstarts/network/hosted.md) guide to setup the controller.
...
ssh root@<ip>
```
Then follow the [Host OpenZiti Anywhere](/learn/quickstarts/network/hosted.md) to setup the controller. You must replace the EXTERNAL_DNS with the following command before running the quickstart.
...
ZAC provides GUI for managing the OpenZiti network. If you prefer UI over CLI to manage network, please following the [ZAC Setup Guide](/learn/quickstarts/zac/index.md) to setup ZAC before going to the next section.
...
After the nodejs is installed, following the rest of [ZAC Setup Guide](/learn/quickstarts/zac/index.md) to setup ZAC.

---
title: Troubleshoot OIDC with the ziti CLI
...
# Troubleshoot OIDC with the `ziti` CLI
...
![invalid client id](@openziti_img/idps/keycloak/invalid_client.png)
...
![invalid scope](@openziti_img/idps/keycloak/invalid_scope.png)

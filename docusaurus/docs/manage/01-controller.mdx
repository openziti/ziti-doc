...
The Ziti Controller is the process that coordinates a [Ziti Networks](./index#overview-of-a-ziti-network). It
...
[Ziti Networks](./index#overview-of-a-ziti-network) will have two important metrics: CPU and network capacity.

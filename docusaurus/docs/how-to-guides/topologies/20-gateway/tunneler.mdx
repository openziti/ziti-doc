...
Login to your **local-tunnel** machine/VM. Follow [Install Linux Package:](../../../how-to-guides/tunnelers/60-linux/index.mdx) **Ubuntu Jammy 22.04** section to install and register your `ziti-edge-tunnel`. Use the **local-tunnel.jwt** created earlier for its identity token.

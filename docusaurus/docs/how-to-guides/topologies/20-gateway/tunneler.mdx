...
- An open-ziti network should be created already. If not, please follow this quickstart [Host OpenZiti Anywhere](../../../intro/get-started/network/hosted.mdx) guide to set up a ziti network first.

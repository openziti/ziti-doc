...
- Public edge router (**pub-er**) was setup in the [Router setup section](../deployments/40-cloud/20-router.mdx#23-create-and-set-up-router-directly-on-router-vm), this router provides fabric and edge connection. It does not have tunneler functionality. Make sure you also modify the [Firewall](@openzitidocs/how-to-guides/deployments/40-cloud/20-router#29-firewall) for this router.
- Local edge router (**local-er**). Please follow the [Router guide](../deployments/40-cloud/20-router.mdx) to setup a [Router with edge listener and tunneler](../deployments/40-cloud/20-router.mdx#2343-create-the-router-with-edge-listener-and-tunneler). For this router, you will need to setup [Resolver](@openzitidocs/how-to-guides/deployments/40-cloud/20-router#26-fix-the-resolver), [Route Table](@openzitidocs/how-to-guides/deployments/40-cloud/20-router#27-route-table), [Source and Destination Check](@openzitidocs/how-to-guides/deployments/40-cloud/20-router#28-source-and-destination-check) and [Firewall](@openzitidocs/how-to-guides/deployments/40-cloud/20-router#29-firewall).
...
We need two tunnelers for our testing. Please follow **[Create a VM section](@openzitidocs/how-to-guides/deployments/40-cloud/10-controller#11-create-a-vm-to-be-used-as-the-controller)** of the Controller Guide to create two VMs running Ubuntu 22.04.

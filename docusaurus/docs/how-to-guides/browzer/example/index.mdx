...
["host it anywhere" quickstart](@openziti2x/intro/get-started/network/hosted). It will use Ubuntu Linux as well, if
...
following the steps outlined in the ["host it anywhere"](@openziti2x/intro/get-started/network/hosted)
...
__["host it anywhere" quickstart](@openziti2x/intro/get-started/network/hosted)__ instructions.  Run the quickstart
...
install ZAC first. Follow [the ZAC install guide](@openziti2x/intro/get-started/zac).
...
BrowZer is ready to be installed. The [main BrowZer page](@openziti2x/how-to-guides/browzer) has two sections showing you how to
install BrowZer either by [cloning from GitHub](@openziti2x/how-to-guides/browzer#cloning-from-github)
or by [Running via Docker](@openziti2x/how-to-guides/browzer#running-via-docker). I have

...
import Highlight from "@openziti/src/components/OpenZitiHighlight";
import ReactPlayer from 'react-player'

This page will demonstrate adding BrowZer to an existing network that was started using the
["host it anywhere" quickstart](@openzitidocs/intro/get-started/network/hosted). It will use Ubuntu Linux as well, if
...
following the steps outlined in the ["host it anywhere"](@openzitidocs/intro/get-started/network/hosted)
...
__["host it anywhere" quickstart](@openzitidocs/intro/get-started/network/hosted)__ instructions.  Run the quickstart
...
install ZAC first. Follow [the ZAC install guide](@openzitidocs/intro/get-started/zac).
...
BrowZer is ready to be installed. The [main BrowZer page](@openzitidocs/how-to-guides/browzer) has two sections showing you how to
install BrowZer either by [cloning from GitHub](@openzitidocs/how-to-guides/browzer#cloning-from-github)
or by [Running via Docker](@openzitidocs/how-to-guides/browzer#running-via-docker). I have

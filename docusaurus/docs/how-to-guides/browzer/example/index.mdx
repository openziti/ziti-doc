...
["host it anywhere" quickstart](@openziti2x/get-started/network/hosted). It will use Ubuntu Linux as well, if
...
following the steps outlined in the ["host it anywhere"](@openziti2x/get-started/network/hosted)
...
__["host it anywhere" quickstart](@openziti2x/get-started/network/hosted)__ instructions.  Run the quickstart
...
install ZAC first. Follow [the ZAC install guide](@openziti2x/get-started/zac).

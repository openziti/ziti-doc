...
If you have used the [Local - No Docker](@openziti2x/get-started/network/local-no-docker) or the
["host it anywhere" quickstart](@openziti2x/get-started/network/hosted) quickstarts, you would have sourced the 

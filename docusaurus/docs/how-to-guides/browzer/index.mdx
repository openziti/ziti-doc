...
* create an [external jwt signer](../../../learn/core-concepts/security/authentication/70-external-jwt-signers.mdx)
* create an [authentication policy](../../../learn/core-concepts/security/authentication/50-authentication-policies.md)
...
If you have used the [Local - No Docker](../network/local-no-docker.mdx) or the
["host it anywhere" quickstart](../network/hosted.mdx) quickstarts, you would have sourced the  

...
2.  Click **+** to bring up the **CREATE EDGE ROUTER** widget. The **NAME** of Router is required, and it has to be unique. Also choose whether you want the tunneler to be enable or not on the router.  Enter other optional fields and hit **SAVE**
...
4.  Click the **JWT ICON**, the JWT will be downloaded to your machine. On Chrome browser, the downloaded file will appear on the bottom left corner of the browser like picture below.
...
4.  Click the route table, then choose **Routes** from the left side menu.
...
2.  To get to the route table, click **Subnet** from your Instances screen
3.  From the Subnet screen, click **Router table**
...
1.  Go to your VM screen, click the **Network interfaces** name (i.e. nic0)
2.  Click **Routes** menu on the left side to bring up the Routes screen
...
2.  From your Virtual machine screen, click the **Network Interface** of that VM. 
...
1.  From your Instance screen, Under **Networking** tab, click the **Network Interface** of that VM. 
2.  Click **Actions** on the right side to bring up a dropdown menu. 
...
1.  From the Instance details screen, click the **Attached VNICs** from the left side menu
...
1.  From your Virtual machine page, click **Networking** from the left side menu.
2.  Under the **Inbound port rules**, you can click **Add inbound port rule** to allow traffic in. Like example here.

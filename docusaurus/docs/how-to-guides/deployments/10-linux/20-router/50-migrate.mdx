---
title: Migrate the router installation
sidebar_label: Migrate the router
---
...
1. Follow [the Linux router deployment guide](/how-to-guides/deployments/10-linux/20-router/10-deploy.mdx) to install the controller service.

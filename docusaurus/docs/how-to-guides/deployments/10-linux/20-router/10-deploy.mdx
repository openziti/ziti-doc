...
Deploy a router as a Linux system service. [The router introduction](@openziti2x/intro#components) may help to read first.
...
Create the router in the controller first with [the web console](/how-to-guides/deployments/10-linux/30-console.mdx) or [the CLI](/how-to-guides/deployments/10-linux/20-router/40-cli-mgmt.mdx).

After [creating the router](/how-to-guides/deployments/10-linux/20-router/40-cli-mgmt.mdx#create-a-router), save the enrollment token (JWT) for the configuration step below.

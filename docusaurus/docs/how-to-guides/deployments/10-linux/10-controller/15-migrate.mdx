---
title: Migrate the controller installation
sidebar_label: Migrate the controller
---
...
1. Follow [the Linux controller deployment guide](/how-to-guides/deployments/10-linux/10-controller/10-deploy.mdx) to install the controller service.

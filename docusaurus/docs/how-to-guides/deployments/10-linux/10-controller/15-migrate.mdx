...
1. Follow [the Linux controller deployment guide](@openzitidocs/how-to-guides/deployments/10-linux/10-controller/10-deploy) to install the controller service.

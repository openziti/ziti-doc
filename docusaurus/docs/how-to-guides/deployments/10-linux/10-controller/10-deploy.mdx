...
Deploy a controller as a Linux system service. [The controller introduction](../../../../intro.md#components) may help to read first.
...
3. [Start the controller](#start-the-controller)

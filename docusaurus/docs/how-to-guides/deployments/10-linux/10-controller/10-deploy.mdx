...
Deploy a controller as a Linux system service. [The controller introduction](@openzitidocs/intro/what-is-openziti/03-components#controller) may help to read first.

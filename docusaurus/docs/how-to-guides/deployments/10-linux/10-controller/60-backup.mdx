---
title: Back up the controller
sidebar_label: Back up the controller
---
...
new intermediate CA cert from the same root CA, and issue new leaf certificates from the new intermediate CA ([link to certificate renewal guide](@openzitidocs/support/troubleshooting/pki-troubleshooting/renew-cert)).

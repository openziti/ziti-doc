...
<img src="@static/icons/logo-authentik.svg" alt="HAuthentik logo" height="100px"/>
...
on **Applications** and then click **Create with Provider** and complete the wizard that pops up.

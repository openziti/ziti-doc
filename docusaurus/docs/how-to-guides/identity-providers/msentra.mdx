...
console, find and click the **Microsoft Entra ID** icon in the navbar:
...
which is specific to OpenZiti. Click **Add a scope** and the **Add a scope** popup form will come up. Fill out the 

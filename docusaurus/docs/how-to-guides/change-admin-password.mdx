...
If you installed the console (ZAC) in your quickstart network then you can [login with your current password](../get-started/zac/index.mdx#login-and-use-zac) and change it.

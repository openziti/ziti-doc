...
- network
- [Desktop Tunneler](../../how-to-guides/tunnelers/index.mdx)
...
Follow the guide @[Create Identities](@openzitidocs/learn/core-concepts/identities/overview#creating-an-identity) for the ngx-ziti-module and windows client.
...
- Windows ZDE Identity can be enrolled by following this [enrolling process](@openzitidocs/how-to-guides/tunnelers/02-windows/index)
- Nginx Module Identity can be enrolled by following [Enrolling an Identity Guide](@openzitidocs/learn/core-concepts/identities/20-enrolling)

...
* ZDEW 2.5.2+
* an `external-jwt-signer` is properly configured
...
Obtain a controller's network JWT using the Ziti Admin Console. From the Authentication->JWT Signers page, click 
...
With the JWT on the Windows machine to be added, click the "ADD IDENTITY" button in the top right of the screen. 

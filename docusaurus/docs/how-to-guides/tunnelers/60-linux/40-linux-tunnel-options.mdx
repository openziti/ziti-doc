...
For more information about configuring the underlying Ziti C SDK with environment variables, see [the Ziti C SDK documentation](@openzitidocs/reference/developer/sdk/ziti-sdk-c).

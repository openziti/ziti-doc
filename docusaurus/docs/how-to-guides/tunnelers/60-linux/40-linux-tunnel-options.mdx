---
title: Configure options and modes
sidebar_label: Options and modes
---
...
For more information about configuring the underlying Ziti C SDK with environment variables, see [the Ziti C SDK documentation](/reference/developer/sdk/clang/index.md).

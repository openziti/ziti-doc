...
<ReactPlayer width={500} playing={true} loop={false} controls url='/AppetizerDemo.mov' />

<AsciinemaWidget fit={false} src="/appetizer.cast" rows={30} loop={false} autoplay={1} preload={true} />

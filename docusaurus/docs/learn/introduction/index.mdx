...
* [Tunneling applications](/docs/learn/core-concepts/clients/tunnelers/) providing zero trust access to those applications you cannot embed zero trust into directly

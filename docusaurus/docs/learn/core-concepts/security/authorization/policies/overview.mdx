...
# Policies
Ziti policies control which [Identities](../../authentication/60-identities.md) can access or host which services
...
When an Identity is trying to establish an [API Session](../../sessions.md#api-session) to use or host a service, the Ziti

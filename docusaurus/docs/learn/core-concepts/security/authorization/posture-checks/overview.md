...
|                                  | [Legacy Posture Checks](./legacy-posture.md)        | [OIDC Posture Checks](./oidc-posture.md)                  |
|----------------------------------|----------------------------------------------------|-----------------------------------------------------------|
...
enforcement system is in use. See the [Legacy](./legacy-posture.md#types) or [OIDC](./oidc-posture.md#types) pages for type details
...
(see [Legacy](./legacy-posture.md#mfa) / [OIDC](./oidc-posture.md#mfa)) is one exception — it defines grace

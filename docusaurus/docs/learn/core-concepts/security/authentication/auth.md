...
- Clients that are powered by a Ziti SDK that access services will authenticate with the [Edge Client API](/docs/reference/developer/api#edge-client-api)
- Clients that are managing a Ziti Network will authenticate with the [Edge Management API](/docs/reference/developer/api#edge-management-api)

## Authentication Flow

Below is diagram showing initial authentication for some client. The same model is used between the [Edge Client API](/docs/reference/developer/api#edge-client-api)
and [Edge Management API](/docs/reference/developer/api#edge-management-api).
...
[API Sessions](../sessions.md#api-session) are represented by opaque strings and are provided in the HTTP header `zt-session` and in Edge Router
...
or via the [Edge Management API](/docs/reference/developer/api#edge-management-api):

...
API Sessions are a high level security context that represents an authenticated session with either the Ziti [Edge Client API](/docs/reference/api/edge-apis#edge-client-api)
or the Ziti [Edge Management API](/docs/reference/api/edge-apis#edge-management-api).

- Clients that are powered by a Ziti SDK that access services will authenticate with the [Edge Client API](/docs/reference/api/edge-apis#edge-client-api)
- Clients that are managing a Ziti Network will authenticate with the [Edge Management API](/docs/reference/api/edge-apis#edge-management-api)

## Authentication Flow

Below is diagram showing initial authentication for some client. The same model is used between the [Edge Client API](/docs/reference/api/edge-apis#edge-client-api)
and [Edge Management API](/docs/reference/api/edge-apis#edge-management-api).
...
Through the [Edge Management API](/docs/reference/api/edge-apis#edge-management-api) any API Session may be forcefully removed
...
or via the [Edge Management API](/docs/reference/api/edge-apis#edge-management-api):
...
[3rd Party CA](./third-party-cas) via the Ziti [Edge Management API](/docs/reference/api/edge-apis#edge-management-api), verified, and

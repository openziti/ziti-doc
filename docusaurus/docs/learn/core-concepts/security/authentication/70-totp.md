...
[Authentication Policies](./30-authentication-policies.md) and [Posture Checks](/learn/core-concepts/security/authorization/posture-checks.md#mfa).
...
### MFA Posture Check
When enforced through the [MFA Posture Check](/learn/core-concepts/security/authorization/posture-checks.md#mfa), clients still must become fully 

...
A Ziti Network's security setup is defined by several entities defined in the [Edge Management API](/docs/reference/api/edge-apis#edge-management-api). The following
...
properties on entities within the [Edge Management API](/docs/reference/api/edge-apis#edge-management-api). `roleAttributes` properties are an array of user defined strings.

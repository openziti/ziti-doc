...
[third-party CA](./authentication/30-third-party-cas.md). When creating an identity the `id` of the target
[third-party CA](./authentication/30-third-party-cas.md) is specified.
...
Auto CA enrollment allows a [third-party CA](./authentication/30-third-party-cas.md) to have clients enroll with a
...
[third-party CA](./authentication/30-third-party-cas.md) and ensure that `isAutoCaEnrollmentEnabled` is set to `true`.

The name of enrolling clients is controlled by the `identityNameFormat` of the
[third-party CA](./authentication/30-third-party-cas.md).
The /format supports a number of replacement strings:

- `[caName]` - the OpenZiti `name` of the [third-party CA](./authentication/30-third-party-cas.md) that validates the
  enrolling certificate
- `[caId]` - the OpenZiti `id` of the [third-party CA](./authentication/30-third-party-cas.md) that validates the
  enrolling certificate
...
OpenZiti. If the client's certificate was issued by a [third-party CA](./authentication/30-third-party-cas.md), the

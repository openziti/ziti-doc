...
Ziti network without first creating an [Identity](./authentication/80-identities.md) or distributing a JWT enrollment token. Create a
...
Ziti. If the client's certificate was issued by a [3rd Party CA](./authentication/30-third-party-cas.md), the

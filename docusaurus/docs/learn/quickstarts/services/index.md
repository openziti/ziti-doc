...
The fastest way to start using your network is with "zero trust host access." Install an [OpenZiti tunneler](../../../reference/tunnelers/index.mdx) on your clients and servers and provide access to your services - no code changes required. This is how most deployments start and is a fully supported production model. Follow the [Your First Service](../../../learn/quickstarts/services/ztha.md) quickstart to get going.

...
OpenZiti requires explicit authorization of identities using ([edge router policies](/reference/glossary#edge-router-policy)), 
as well as authorization of services and routers using ([service edge router policies](/reference/glossary#service-edge-router-policy)). 
...
- [Install the console](/learn/quickstarts/zac/index#using-docker) (web UI)

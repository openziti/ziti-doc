...
:::info
Quickstarts are short-lived networks that are great for learning how to Ziti all the things! For long-lived production deployments, see [the deployment guides](/docs/category/docker).
:::

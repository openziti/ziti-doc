...
a [controller](/docs/category/controller). Without a controller, edge routers won't be able to authorize new
...
At this point you should have [a controller](/docs/category/controller) running. You should have created your

...
You can absolutely choose to host your [network](/learn/introduction/index) anywhere you like.
...
When starting out deploying a [network](/learn/introduction/index), we recommend you follow
...
- Now that you have your network in place, you probably want to try it out. Head to the
  [Your First Service](/learn/quickstarts/services/index) quickstart and start learning how to use OpenZiti.
- [Install the console](/learn/quickstarts/zac/index) (web UI)

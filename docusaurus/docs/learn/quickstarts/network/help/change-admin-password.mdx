...
If you installed the console (ZAC) in your quickstart network then you can [login with your current password](/learn/quickstarts/zac/index#login-and-use-zac) and change it.

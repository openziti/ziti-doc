...
["host it anywhere" quickstart](/learn/quickstarts/network/hosted). It will use Ubuntu Linux as well, if
...
following the steps outlined in the ["host it anywhere"](/learn/quickstarts/network/hosted)
...
__["host it anywhere" quickstart](/learn/quickstarts/network/hosted)__ instructions.  Run the quickstart
...
install ZAC first. Follow [the ZAC install guide](/learn/quickstarts/zac/index).
...
BrowZer is ready to be installed. The [main BrowZer page](/learn/quickstarts/browzer/index) has two sections showing you how to
install BrowZer either by [cloning from GitHub](/learn/quickstarts/browzer/index#cloning-from-github)
or by [Running via Docker](/learn/quickstarts/browzer/index#running-via-docker). I have

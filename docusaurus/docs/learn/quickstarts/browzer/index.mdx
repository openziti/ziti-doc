...
of enabling BrowZer, see the [Example Enabling BrowZer](./example/index) subpage showing the steps in more detail.
...
If you have used the [Local - No Docker](/learn/quickstarts/network/local-no-docker) or the
["host it anywhere" quickstart](/learn/quickstarts/network/hosted) quickstarts, you would have sourced the  

...
of enabling BrowZer, see the [Example Enabling BrowZer](./example/index.mdx) subpage showing the steps in more detail.
...
* create an [external jwt signer](../../../learn/core-concepts/security/authentication/50-external-jwt-signers.mdx)
* create an [authentication policy](../../../learn/core-concepts/security/authentication/30-authentication-policies.md)

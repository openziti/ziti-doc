...
import Wizardly from '@openziti/src/components/Wizardly';
import { ConsolePublicCertsNote } from '../../_imports.tsx';

# 2. Install the ZAC

The Ziti Administration Console (ZAC) is a web UI provided by the OpenZiti project which will allow you to configure and
explore a [network](@openziti2x/intro).
...
controller. These steps apply to a controller you have already deployed. When complete, the controller will host
...
If you have used the Docker quickstart to start
...
If you have followed the Docker Compose quickstart you will have the ZAC
...
[Kubernetes deployment guide](../../how-to-guides/deployments/30-kubernetes/kubernetes-console.mdx).
...
3. Optionally, [**change admin's password**](../../how-to-guides/change-admin-password.mdx#ziti-console)

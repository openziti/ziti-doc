...
network level, the host level, or directly inside your application, every connection is authenticated, authorized,
...
- **End-to-end encryption**: Every connection is encrypted from endpoint to endpoint using public-private-key
  ...
  own traffic. See [connection security](@openzitidocs/learn/core-concepts/security/connection-security).

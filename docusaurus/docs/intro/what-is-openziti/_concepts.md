...
Read more about end-to-end encryption and security for other connections on the [Connection Security](@openzitidocs/learn/core-concepts/security/connection-security) page.

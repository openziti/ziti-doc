...
This page will show you how to get your [network](@openzitidocs/intro/intro) up and running 
...
At this point you should have a functioning [network](@openzitidocs/intro/intro). The script 

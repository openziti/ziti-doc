...
This page will show you how to get your [network](../../../intro/what-is-openziti/index.mdx) up and running 
...
At this point you should have a functioning [network](../../../intro/what-is-openziti/index.mdx). The script 

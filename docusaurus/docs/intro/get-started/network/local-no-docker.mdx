...
This page will show you how to get your [network](@openziti2x/intro/intro) up and running 
...
At this point you should have a functioning [network](@openziti2x/intro/intro). The script 

...
:::info
Quickstarts are short-lived networks that are great for learning how to use OpenZiti. For long-lived production deployments, see [the deployment guides](@openziti2x/category/docker).
:::
...
All [networks](../../../intro/what-is-openziti/index.mdx) require
...
- [Install the console](../zac/index.mdx#using-docker) (web UI)

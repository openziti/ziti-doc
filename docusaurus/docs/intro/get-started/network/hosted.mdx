...
You can absolutely choose to host your [network](../../../intro/what-is-openziti/index.mdx) anywhere you like.
...
When starting out deploying a [network](../../../intro/what-is-openziti/index.mdx), we recommend you follow

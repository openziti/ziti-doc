...
You can absolutely choose to host your [network](@openziti2x/intro/intro) anywhere you like.
...
When starting out deploying a [network](@openziti2x/intro/intro), we recommend you follow

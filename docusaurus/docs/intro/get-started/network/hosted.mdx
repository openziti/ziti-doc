...
You can absolutely choose to host your [network](@openzitidocs/intro/intro) anywhere you like.
...
When starting out deploying a [network](@openzitidocs/intro/intro), we recommend you follow

...
1. To use the CLI, you'll need to be logged in. [Link to instructions](@openzitidocs/reference/40-command-line/login)

1. <CliChangeUpdb/>

## Use the Ziti Console {#ziti-console}

If you installed the console (ZAC) in your quickstart network then you can [login with your current password](../../zac/index.mdx#login-and-use-zac) and change it.

Click on the person icon on the lower left and then select "Edit Profile" as shown to change your password.

![change password screenshot](../../zac/zac_change_pwd.png)

...
["host it anywhere" quickstart](../../network/hosted.mdx). It will use Ubuntu Linux as well, if
...
following the steps outlined in the ["host it anywhere"](../../network/hosted.mdx)
...
__["host it anywhere" quickstart](../../network/hosted.mdx)__ instructions.  Run the quickstart
